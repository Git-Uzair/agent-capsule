...
- attempt 5: use bound result builder in handleToolsCallGateway, enforce GATEWAY_NAME_PATTERN ^[a-zA-Z0-9_-]{1,64}$ at install and gateway build -> PASS (P2-1/P2-2 core verified)
